...
public class SclAdminSearchSchedulePageObject {
	...
	private static By txtSearchclass=By.xpath("//span[text()='Plants -']");
	private static By deletebtn=By.xpath("//button[@class='btn btn-danger']");
	private static By clicksessionlink=By.xpath("//a[text()='https://zoom.us/ ']");
	...
	public static void ClickOngivensessionLink()   {
		ElementActions.click(clicksessionlink);		
	}


	public static void OpentheSessionLink()   { 
		...
		String TestCurntURL = ElementActions.getDriver().getCurrentUrl();
		System.out.println(TestCurntURL);
		assertEquals("https://zoom.us/", TestCurntURL);
